...
3. [Jupyter Lab Notebook](#jupyter-lab-notebook)
4. [How to Use](#how-to-use)
5. [Requirements](#requirements)

### Separate Files Implementation

The code is primarily split into various files, each handling a specific part of the model. Please refer to the individual files for detailed implementation and comments.

### Combined Implementation (`AlgorithmicTraderModel.py`)

In case the separate files implementation does not work on your system, a combined code file named [`AlgorithmicTraderModel.py`](./AlgorithmicTraderModel.py) is provided. Simply run this file instead of the separate ones.

### Jupyter Lab Notebook

A Jupyter Lab Notebook is included, showcasing thorough testing and documentation of the code. It provides insights into the development process and the testing performed on the algorithms. [Click here to view the notebook](./your_notebook_name.ipynb).
